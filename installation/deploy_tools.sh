...
git clone https://github.com/lingyanruan/DRBNet.git executor/defocus_deblurring/tools/DRBNet
git clone https://github.com/codeslake/IFAN.git executor/defocus_deblurring/tools/IFAN
git clone https://github.com/swz30/Restormer.git executor/defocus_deblurring/tools/Restormer

git clone https://github.com/IDKiro/DehazeFormer.git executor/dehazing/tools/DehazeFormer
git clone https://github.com/google-research/maxim.git executor/dehazing/tools/maxim
git clone https://github.com/RQ-Wu/RIDCP_dehazing.git executor/dehazing/tools/RIDCP_dehazing
git clone https://github.com/Andrew0613/X-Restormer.git executor/dehazing/tools/X-Restormer

git clone https://github.com/swz30/MPRNet.git  executor/denoising/tools/MPRNet
git clone https://github.com/JingyunLiang/SwinIR.git executor/denoising/tools/SwinIR
